...
<li>Friends and people who have problems with me are strictly prohibited from obtaining licenses forever. Even if the problematic friend works for a government agency, the same rules apply to that agency. back to point number 7 (i have big data private so no can lie)</li>
