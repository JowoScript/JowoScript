...
<li>Especially for those who insert sound into music at Disc Jockey (DJ) and the conclusion is that the sound is changed into music for cursing and being alone, the perpetrator must die first if there is a company or government that wants to buy the license. Life is a choice. Rules is a rules. Dare to curse but don't dare to take risks. back to point number 7</li>
